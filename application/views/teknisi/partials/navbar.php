    ...
    <nav class="grey darken-3">
        <div class="nav-wrapper">
            ...
            <ul id="laporan_DD" class="dropdown-content">
                <li><a href="<?php echo base_url('teknisi/laporan/show_laporan_semua'); ?>" class="">Semua Laporan</a></li>
                <li><a href="<?php echo base_url('teknisi/laporan/show_laporan_dk'); ?>" class="">Sedang Dikerjakan</a></li>
                <li><a href="<?php echo base_url('teknisi/laporan/show_laporan_mk'); ?>" class="">Menunggu Konfirmasi</a></li>
                <li><a href="<?php echo base_url('teknisi/laporan/show_laporan_s'); ?>" class="">Selesai</a></li>
            </ul>
                ...
                foreach ($notif->result() as $n) :
                    if ($max <= 10) :
                        ...
                        <li><a href="<?php
                                                ...
                                                echo base_url('teknisi/laporan/show_laporan_and_read?id=' . $n->nomor_laporan . '&&jenis_laporan=' . $jenis_laporan . '&&id_komentar=' . $n->id_komentar) ?>"><?php
            ...
            <ul id="nav-mobile" class="right hide-on-med-and-down">
                <li><a href="<?php echo base_url('teknisi/dashboard') ?>" class="bold-font">Home</a></li>
